 ...
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * | Tab  |   Q  |   W  |   F  |   P  |   B  |                    |   J  |   L  |   U  |   Y  |   ;  |  Ü   |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * |LCTRL |   A  |   R  |   S  |   T  |   G  |-------.    ,-------|   M  |   N  |   E  |   I  |   O  |  Ä   |
 * |------+------+------+------+------+------|   #   |    | PLAY  |------+------+------+------+------+------|
 ...
 */
[_CMDH] = LAYOUT(
    TD(TD_ESC_GRV),  KC_1,   KC_2,    KC_3,    KC_4,    KC_5,                     KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS,
            KC_TAB,   KC_Q,   KC_W,    KC_F,    KC_P,    KC_B,                     KC_J,    KC_L,    KC_U,    KC_Z,    KC_P,    KC_LBRC,
            KC_LCTRL, KC_A,   KC_R,    KC_S,    KC_T,    KC_G,                     KC_M,    KC_N,    KC_E,    KC_I,    KC_O,    KC_QUOT,
            KC_LSFT,  KC_Y,   KC_X,    KC_C,    KC_D,    KC_V, KC_BSLASH,KC_MPLY,  KC_K,    KC_H,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
...
[_QWERTY] = LAYOUT(
            ...
            KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_BSLASH,KC_MPLY,  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
                                    KC_LALT, KC_LGUI,LOWER, KC_SPC,          KC_ENT,   RAISE,   KC_BSPC, KC_RALT
),
...
[_LOWER] = LAYOUT(
    ...
    _______, _______, _______, _______, _______, _______, _______,RSFT(KC_F22), XXXXXXX, KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR, KC_PIPE,
 ...
 */
[_ADJUST] = LAYOUT(
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                   CMDH   ,   QWERT, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
...
/*
void dance_circumflex(qk_tap_dance_state_t *state, void *user_data) {
        SEND_STRING("``");
}
...
qk_tap_dance_action_t tap_dance_actions[] = {
    ...
    [TD_ESC_GRV] = ACTION_TAP_DANCE_FN(dance_circumflex),
};
*/
